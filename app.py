...
app = Flask(__name__)
app.config['MONGO_URI'] = 'mongodb+srv://himanshu:himanshu@cluster0.cyv3gab.mongodb.net/BookShowBizz?retryWrites=true&w=majority'
app.config['JWT_SECRET_KEY'] = 'himanshu'
mongo = PyMongo(app)
bcrypt = Bcrypt(app)
jwt = JWTManager(app)
...
@app.route("/")
def get():
    return "Welcome to BookShowBizz"
